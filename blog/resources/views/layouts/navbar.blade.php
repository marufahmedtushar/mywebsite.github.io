    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link waves-effect waves-dark sidebar-link {{ 'contact' == request()->path() ? 'active' : '' }}" href="/contact" aria-expanded="false">
                        <i class="mdi mdi-face"></i>
                        <span class="hide-menu">People's</span>
                    </a>
                </li>
            </ul>
        </nav>
